...
/**
 * \file    test/functional/ConsigneFunctionalTest.php
 * \ingroup consigne
 ...
 *
 * @package Testconsigne
 */
class ConsigneFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
...
//        )
	...
	{
		$this->url('/custom/consigne/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('consigne/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/consigne/admin/about.php');
		$this->authenticate();
		return $this->assertContains('consigne/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('consignewidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modConsigne_ConsigneTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modConsigne_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
