...
/**
 *  \file       consigneproduct_agenda.php
 *  \ingroup    consigne
 *  \brief      Page of ConsigneProduct events
 */
...
$hookmanager->initHooks(array('consigneproductagenda'));     // Note that conf->hooks_modules contains array
...
if ($object->id > 0)
{
	...
	dol_fiche_head($head, 'agenda', $langs->trans("ConsigneProduct"), -1, 'consigneproduct@consigne');
    ...
    if (! empty($conf->agenda->enabled) && (!empty($user->rights->agenda->myactions->read) || !empty($user->rights->agenda->allactions->read) ))
    {
		...
		print load_fiche_titre($langs->trans("ActionsOnConsigneProduct"),'','');
