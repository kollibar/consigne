...
/**
 *  \file       consigneproduct_note.php
 *  \ingroup    consigne
 *  \brief      Car with notes on ConsigneProduct
 */
...
$hookmanager->initHooks(array('consigneproductnote'));     // Note that conf->hooks_modules contains array
...
$help_url='';
llxHeader('',$langs->trans('ConsigneProduct'),$help_url);
...
if ($id > 0 || ! empty($ref))
{
	...
	dol_fiche_head($head, 'note', $langs->trans("ConsigneProduct"), -1, 'consigneproduct@consigne');
