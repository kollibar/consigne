...
/**
 *  \file       consigneproduct_document.php
 *  \ingroup    consigne
 *  \brief      Tab for documents linked to ConsigneProduct
 */
...
$hookmanager->initHooks(array('consigneproductdocument'));     // Note that conf->hooks_modules contains array
...
$title=$langs->trans("ConsigneProduct").' - '.$langs->trans("Files");
$help_url='';
...
if ($object->id)
{
	...
	dol_fiche_head($head, 'document', $langs->trans("ConsigneProduct"), -1, 'consigneproduct@consigne');
	...
	//$relativepathwithnofile='consigneproduct/' . dol_sanitizeFileName($object->id).'/';
	$relativepathwithnofile='consigneproduct/' . dol_sanitizeFileName($object->ref).'/';
