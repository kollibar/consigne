...
/**
 * \file    modulebuilder/template/core/boxes/consignewidget1.php
 * \ingroup consigne
 * \brief   Widget provided by Consigne
 *
 ...
 */
class consignewidget1 extends ModeleBoxes
{
	/**
	 * @var string Alphanumeric ID. Populated by the constructor.
	 */
	public $boxcode = "consignebox";

	/**
	 * @var string Box icon (in configuration page)
	 * Automatically calls the icon named with the corresponding "object_" prefix
	 */
	public $boximg = "consigne@consigne";
	...
	public function __construct(DoliDB $db, $param = '')
	{
		...
		//$this->hidden = ! ($user->rights->consigne->myobject->read);   // Condition when module is visible by user (test on permission)
	}
	...
	public function loadBox($max = 5)
	{
		...
		//include_once DOL_DOCUMENT_ROOT . "/consigne/class/consigne.class.php";

		// Populate the head at runtime
		$text = $langs->trans("ConsigneBoxDescription", $max);
		$this->info_box_head = array(
			...
			'subpicto' => 'object_consigne@consigne',
