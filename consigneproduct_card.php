...
if ($object->id > 0 && (empty($action) || ($action != 'edit' && $action != 'create')))
{
	...
	if ($action == 'delete')
	{
	    $formconfirm = $form->formconfirm($_SERVER["PHP_SELF"] . '?id=' . $object->id, $langs->trans('DeleteConsigneProduct'), $langs->trans('ConfirmDeleteConsigneProduct'), 'confirm_delete', '', 0, 1);
	}
	...
	*/
	...
	if ($action != 'presend')
	{
		...
		*/
	    ...
	    $linktoelem = $form->showLinkToObjectBlock($object, null, array('consigneproduct'));
	    ...
	    $morehtmlright = '<a href="'.dol_buildpath('/consigne/consigneproduct_info.php', 1).'?id='.$object->id.'">';
	    ...
	    $somethingshown = $formactions->showactions($object, 'consigneproduct', $socid, 1, '', $MAXEVENT, '', $morehtmlright);
