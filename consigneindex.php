...
/**
 *	\file       htdocs/consigne/template/consigneindex.php
 *	\ingroup    consigne
 *	\brief      Home page of consigne top menu
 */
...
$langs->loadLangs(array("consigne@consigne"));

$action=GETPOST('action', 'alpha');


// Securite acces client
if (! $user->rights->consigne->read) accessforbidden();
...
llxHeader("",$langs->trans("ConsigneArea"));

print load_fiche_titre($langs->trans("ConsigneArea"),'','consigne.png@consigne');
...
// Draft MyObject
if (! empty($conf->consigne->enabled) && $user->rights->consigne->read)
{
	$langs->load("orders");
